...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SensorEventListener {
    ...
    @BindView(R.id.x_actual)
    TextView xActual;
    @BindView(R.id.y_actual)
    TextView yActual;
    @BindView(R.id.z_actual)
    TextView zActual;
    ...
    private void updateMeasuringUi(boolean measuring) {
        ...
        if (measuring) {
            ...
            Snackbar.make(findViewById(R.id.coordinator_main), "Angulo inicial seteado", Snackbar.LENGTH_SHORT).setAction("Action", null).show();
        }
    }
