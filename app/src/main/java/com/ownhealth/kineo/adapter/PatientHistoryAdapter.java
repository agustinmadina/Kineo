 ...
 */
public class PatientHistoryAdapter extends RecyclerView.Adapter<PatientHistoryAdapter.PatientViewHolder> implements Filterable, SectionIndexer {
    ...
    public PatientViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View viewHolder = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_patient_no_edit, parent, false);
